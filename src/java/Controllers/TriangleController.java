...
/*
 * Purpose: Challenge 1 Triangle Controller
 * Author: Greg Bahr
 * Revision: 1.0
 */

public class TriangleController extends HttpServlet {
    private static final String RESULTS_PAGE = "/triangleResults.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        double triangleSideCLength = Math.sqrt((triangleSideALength * triangleSideALength)
